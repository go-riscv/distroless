...
def repositories():
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20250114T204503Z/pool/main/b/base-files/base-files_13.6_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20250114T204503Z/pool/main/c/ca-certificates/ca-certificates_20241223_all.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20250114T204503Z/pool/main/g/glibc/libc-bin_2.40-5_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20250114T204503Z/pool/main/g/glibc/libc6_2.40-5_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20250114T204503Z/pool/main/n/netbase/netbase_6.4_all.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20250114T204503Z/pool/main/o/openssl/openssl_3.4.0-2_riscv64.deb"],
    )
    http_file(
        name = "riscv64_unstable_tzdata",
        downloaded_file_path = "tzdata_2024b-6_all.deb",
        sha256 = "ab9348fae219ce0f07720bf34304b690b88fdaf14c2448b52bae4a2ab6a5849d",
        urls = ["https://snapshot.debian.org/archive/debian/20250114T204503Z/pool/main/t/tzdata/tzdata_2024b-6_all.deb"],
    )
