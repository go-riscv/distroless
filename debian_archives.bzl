...
def repositories():
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20231109T145713Z/pool/main/b/base-files/base-files_13+b1_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20231109T145713Z/pool/main/c/ca-certificates/ca-certificates_20230311_all.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20231109T145713Z/pool/main/g/glibc/libc-bin_2.37-12_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20231109T145713Z/pool/main/g/glibc/libc6_2.37-12_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20231109T145713Z/pool/main/n/netbase/netbase_6.4_all.deb"],
    )
    http_file(
        name = "riscv64_unstable_openssl",
        downloaded_file_path = "openssl_3.0.12-2_riscv64.deb",
        sha256 = "0a877d72b754739f78207da23cd52dcf5d3c79fd84420b31e81aa12296c7d4ef",
        urls = ["https://snapshot.debian.org/archive/debian/20231109T145713Z/pool/main/o/openssl/openssl_3.0.12-2_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20231109T145713Z/pool/main/t/tzdata/tzdata_2023c-10_all.deb"],
    )
