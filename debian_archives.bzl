...
def repositories():
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20240301T214050Z/pool/main/b/base-files/base-files_13+b2_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20240301T214050Z/pool/main/c/ca-certificates/ca-certificates_20240203_all.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20240301T214050Z/pool/main/g/glibc/libc-bin_2.37-15_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20240301T214050Z/pool/main/g/glibc/libc6_2.37-15_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20240301T214050Z/pool/main/n/netbase/netbase_6.4_all.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20240301T214050Z/pool/main/o/openssl/openssl_3.1.5-1.1_riscv64.deb"],
    )
    http_file(
        ...
        urls = ["https://snapshot.debian.org/archive/debian/20240301T214050Z/pool/main/t/tzdata/tzdata_2024a-1_all.deb"],
    )
